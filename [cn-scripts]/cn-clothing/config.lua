...
custom_models = {'AdaCasualA','a_f_y_tourist_01','a_f_y_tourist_02','player_two','player_one','ig_lamardavis','a_f_y_hipster_01','ig_bankman','Lana','Lou_met','player_niko','Id_3360_mai','Id_3360_mai2','ID361_Barn','Lan_met1','Lan_met2','Lan_met3','Sam_lou','Mette','Mette2','a_c_shepherd'}
custom_models2 = {'squirtle','charmander','a_c_rottweiler'}
menu_options = {
    {name = "Tøj", f = customise, param = nil},
    {name = "Tøj nofilter", f = customisedebug, param = nil},
    {name = "Udsmykning", f = accessories, param = nil},
    {name = "Herre Modeller", f = listModels, param = male_models},
    {name = "Kvinde Modeller", f = listModels, param = female_models},
    {name = "Multiplayer modeller", f = listModels, param = mp_models},
	...
	{name = "Hemmeligt", f = listModels, param = custom_models2},
}
player_data  = {
...
local clothing_shops = {
    ...
    {name="Tøjbutik", id=73, x=123.45701599121, y=-228.06033325195, z=54.57},
    {name="Tøjbutik", id=73, x=1190.8471679688, y=2708.4870605469, z=38.26},
    {name="Tøjbutik", id=73, x=-710.16, y=-153.26, z=37.43},
    {name="Tøjbutik", id=73, x=-826.78430175781, y=-1077.7630615234, z=11.35},
    {name="Tøjbutik", id=73, x=1930.2176513672, y=3732.5620117188, z=32.844421386719},
    {name="Tøjbutik", id=73, x=77.017631530762,y=-1399.2258300781,z=29.387626647949},
    {name="Tøjbutik", id=73, x=-167.33003234863,y=-299.80328369141,z=39.733325958252},
    {name="Tøjbutik", id=73, x=-1447.9998779297,y=-241.80767822266,z=49.819648742676},
    {name="Tøjbutik", id=73, x=617.6083984375,y=2766.7014160156,z=42.08810043335},
    {name="Tøjbutik", id=73, x=-3175.4421386719,y=1041.9453125,z=20.863237380981},
    {name="Tøjbutik", id=73, x=-1108.7711181641,y=2709.7624511719,z=19.107870101929},
    {name="Bunker", x=903.87744140625,y=-3200.0222167969,z=-97.187980651855,blipdisabled=true}, --Gundealer
    {name="Tøjbutik", id=73, x=-1188.9022216797, y=-765.75, z=17.33},
    {name="Tøjbutik", id=73, x=4.25, y=6512.88, z=31.87},
    {name="Tøjbutik", id=73, x=423.97610473633, y=-800.35205078125, z=29.502630233765},
    {name="Politi", x=454.50192260742,y=-989.10681152344,z=30.695657211304,blipdisabled=true}, -- midtby
    {name="Politi", x=1850.1092529297,y=3696.5275878906,z=34.277164459229,blipdisabled=true}, -- sandy
    {name="Politi", x=-440.69299316406, y= 5991.2744140625,z= 31.716192245483,blipdisabled=true}, -- Paleto
    {name="EMS", x=299.21356201172,y= -597.38519287109,z= 43.283985137939,blipdisabled=true}, -- Midtby
    {name="EMS", x=-244.41835021973,y= 6323.2827148438,z= 32.436305999756,blipdisabled=true}, -- paleto
    {name="Panther Security", x= -82.499389648438,y= -809.89593505859,z =243.38592529297,blipdisabled=true},
    {name="Ejendomsmægler", x= -132.02108764648,y= -632.93072509766,z= 168.82037353516,blipdisabled=true},
    {name='High Table', x= 3070.8303222656,y= -4694.7504882813,z= 6.0772886276245,blipdisabled=true}, --DK HIGH TABLE
}
incircle = false
Citizen.CreateThread(function()
    for _, item in pairs(clothing_shops) do
        if item.blipdisabled == nil or item.blipdisabled ~= true then
    ...
    while true do
        ...
        for k,v in ipairs(clothing_shops) do
            if(Vdist(pos.x, pos.y, pos.z, v.x, v.y, v.z) < 25.0)then
                DrawMarker(27, v.x, v.y, v.z - 1, 0, 0, 0, 0, 0, 0, 1.8001, 1.8001, 0.5001, 147, 0, 0, 110, 0, 1, 1, 50)
                if(Vdist(pos.x, pos.y, pos.z, v.x, v.y, v.z) < 1)then
                    if (incircle == false) then

                    end
                    incircle = true
                    DrawText3Ds(v.x, v.y, v.z,("Tryk ~g~E~w~ for at tilgå Tøjbutik"))
                ...
                elseif(Vdist(pos.x, pos.y, pos.z, v.x, v.y, v.z) > 7.0)then
