...
local animations = {
  ...
  ['faxekondi'] = {dict = "amb@world_human_drinking@coffee@male@idle_a", anim = "idle_c", locked = false, prop = {propn = "prop_faxe_can", bindex = 28422}, options = {12.0, -1, -1, 50, 1}, useInCar=true,keepplaying=true,upper=true},
    ['pose'] = {blockcontrols = true, locked = false, prop = {propn = "prop_am_pose", bindex = 28422, loc = {0.20, 0.0, 0.0, 20.0, -100.0, 0.0}, rot = 2}, options = {2.0, 1.0, -1, 30, -1}, blocked = false,keepplaying=true},
...
Citizen.CreateThread(function()
    ...
    TriggerEvent('chat:addSuggestion', '/taske', 'Tager din taske af/på.')
    TriggerEvent('chat:addSuggestion', '/vest', 'Tager din skudsikre vest af/på.')
