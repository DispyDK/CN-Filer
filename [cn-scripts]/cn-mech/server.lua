...
function sendToDiscord(name, message)
    ...
    PerformHttpRequest("https://autisthook.com/api/webhooks/597826642819416066/FDEJgX-olbdej52Ra6a4m7cYlsR76Zi_ehItyZ1AHEiqSeKVEUvP4rLpZ2cg7JiOQCTo", function(err, text, headers) end, 'POST', json.encode({avatar_url = "https://i.imgur.com/HUgauWf.png",username = name,content = message}), { ['Content-Type'] = 'application/json' })
end
