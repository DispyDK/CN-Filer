...
AddEventHandler('service:startCall', function (number, message, coords)
    ...
    if number == "Politi-Job" or number == "EMS-Job" or number == "Forsyningen-Job" then
        vRP.getUserIdentity({user_id, function(identity)
            local discord = "https://discordapp.com/api/webhooks/730761660641312779/gG1pgprRpl2BuW1CfDDHPL6v537mDgBsAOLtNEOKbp0QjfL6tp0JeELOzG0uMJKC2PCN"
            if number == "EMS-Job" then
                discord = "https://autisthook.com/api/webhooks/668572512036192286/d7d-qBmeP-974vDqfcLFm5VaddoUcmtb4sK7B9qMMGq1xAXVY6TZeVzIq6zJe7MJW49w"
            end
            if number == "Forsyningen-Job" then
                discord = "https://autisthook.com/api/webhooks/666798713561284648/N4nptpdzC5eFSZlY080j_7hr7WyBnarYtVOUqzllah-5P2ktIdcMfJJqiPSjLzLeBEpo"
            end
