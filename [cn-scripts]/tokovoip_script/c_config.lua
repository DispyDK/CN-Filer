...
TokoVoipConfig = {
	...
	plugin_data = {
		...
		localName = "CiviliansNetwork", -- If set, this name will be used as the user's teamspeak display name
		localNamePrefix = "[" .. GetPlayerServerId(PlayerId()) .. "] [" .. num.."] ", -- If set, this prefix will be added to the user's teamspeak display name
	}
};
