...
local lang = {
  ...
  police = {
    ...
    identity = {
      info = "<b>Fornavn</b>: {2}<br /><b>Efternavn</b>: {1}<br /><b>Alder</b>: {3}<br /><b>CPR</b>: {4}<br /><b>Mobilnummer</b>: {5}<br /><br /><b>Adresse</b>: {6}<br /><b>Firma</b>: {7}<br /><br /><b>Borger id</b>: {8}",
  ...
  vehicle = {
    ...
    gloveroom = {
      title = "> Åben handskerum",
      description = "Åben handskerummet og tag/læg indhold."
    },
    detach_trailer = {
      title = "Fjern trailer",
